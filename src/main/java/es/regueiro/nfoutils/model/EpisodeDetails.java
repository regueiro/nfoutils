...
public class EpisodeDetails extends NfoFile {

	private static final Logger logger = LoggerFactory.getLogger(EpisodeDetails.class);
	...
	public void cleanEmptyTags() {
		for (Field field : EpisodeDetails.class.getDeclaredFields()) {
